...
--
-- Host: 127.0.0.1
-- Tempo de geração: 21-Set-2024 às 21:46
...
CREATE TABLE `p1` (
  ...
  `NomePai` varchar(55) DEFAULT NULL,
  `NomeMae` varchar(55) DEFAULT NULL,
  `Id_EstadoCivil` int(1) NOT NULL,
  `CPF` varchar(14) NOT NULL,
  `RG` varchar(9) NOT NULL,
  `CNH` int(11) DEFAULT NULL,
  `ValidadeCNH` date DEFAULT NULL,
  `Id_CategoriaCNH` int(1) DEFAULT NULL,
  `Id_SATCNH` int(1) DEFAULT NULL,
  `CEP` int(8) NOT NULL,
  ...
  `TelefoneRecados` varchar(14) DEFAULT NULL,
...
INSERT INTO `p1` (`id`, `RE`, `NomeCompleto`, `NomeGuerra`, `DataNascimento`, `DataAdmissao`, `Id_TipoSanguineo`, `Id_CidadeNatal`, `Id_CidadeEndereco`, `NomePai`, `NomeMae`, `Id_EstadoCivil`, `CPF`, `RG`, `CNH`, `ValidadeCNH`, `Id_CategoriaCNH`, `Id_SATCNH`, `CEP`, `Endereco`, `Numero`, `Id_Logradouro`, `Bairro`, `Complemento`, `NomeConjuge`, `DtNascConjuge`, `Id_Sexo`, `Telefone1`, `Telefone2`, `TelefoneRecados`, `img`, `Id_graduacao`) VALUES
(1, 123456, 'João da Silva', 'Silva', '1985-03-15', '2010-06-12', 1, 10, 25, 'José da Silva', 'Maria da Silva', 2, '123.456.789-00', '0', 123456789, '2025-10-20', 3, 1, 12345, 'Rua Exemplo', 123, 2, 'Bairro Centro', 'Apto 201', 'Ana da Silva', '1990-05-20', 1, '(31) 91234-567', '(31) 99876-543', '(31) 93456-789', 'img001.jpg', 4);
